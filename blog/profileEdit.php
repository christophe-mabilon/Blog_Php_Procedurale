...
<?php require_once dirname(__FILE__) . '/../navbar.php'; ?>
        ...
        <?php foreach ($resultatRequeteProfil as $value) { ?>
            ...
            <img src="../images/profiles/<?php echo $value['images']; ?>">
<p>modifier la photo :</p>
            <form action="" method="POST" enctype="multipart/form-data">

                    <input type="hidden" name="profilePic" value="upload">

                    <input type="hidden" name="userId" value="<?php echo $value[
                        'id'
                    ]; ?>">
...
<input class="form-control" type="text" name="display_name" id="" value="<?php echo $value[
    'display_name'
]; ?>" placeholder="votre display name">
<input class="form-control" type="text" name="email" id="" value="<?php echo $value[
    'email'
